...
cat ${LOVE_DIR}/love.exe ${GAME_ASSET} > "$GAME_EXE"
...
# 			;;
# 	esac
# 	echo ${WINE} ${RCEDIT} "$GAME_EXE" --set-icon "$ICO"
# 	${WINE} ./${RCEDIT} "$GAME_EXE" --set-icon "$ICO"
# fi
...
# fi
# LUASTEAM_DLL=https://github.com/uspgamedev/luasteam/releases/download/v1.0.4/win${ARCH_BITS}_luasteam.dll
